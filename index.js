...
┊${chalk.blueBright('┊')}${chalk.cyan(`😺 Project Author: ${packageJsonObj.author.name} (@sebas.mvp)`)}
┊${chalk.blueBright('┊')}${chalk.blueBright('┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('┊')}${chalk.yellow(`😼👊 Colaboradores:`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`• Cuis (Jonathan Ofc)`)}
┊${chalk.blueBright('┊')}${chalk.yellow(`• Pollito (Ismael Ofc)`)}
┊${chalk.blueBright('╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')}
