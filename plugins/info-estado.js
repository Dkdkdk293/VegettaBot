/**
POR FAVOR TENGAN LA AMABILIDAD Y BONDAD DE NO CAMBIAR MÍNIMAMENTE LOS CRÉDITOS DE VEGETTABOT, 
...
╰━━━━━━━━━━━━━━━━━━⬣`
await conn.sendButton(m.chat, estado, `𝙑𝙀𝙂𝙀𝙏𝙏𝘼 𝘽𝙊𝙏 - 𝘼𝙎𝙄𝙎𝙏𝙀𝙉𝘾𝙄𝘼\n${asistencia}\n\n` + wm, pp, [
['𝙈𝙚𝙣𝙪́ 𝙘𝙤𝙢𝙥𝙡𝙚𝙩𝙤', '.allmenu'],
['𝙑𝙚𝙡𝙤𝙘𝙞𝙙𝙖𝙙', '/ping'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́', '#menu']], null, [
['𝙑𝙀𝙂𝙀𝙏𝙏𝘼 𝘽𝙊𝙏', `${md}`]], m)
/*conn.sendHydrated(m.chat, estado, `𝙑𝙀𝙂𝙀𝙏𝙏𝘼 𝘽𝙊𝙏 - 𝘼𝙎𝙄𝙎𝙏𝙀𝙉𝘾𝙄𝘼\n${asistencia}\n\n` + wm, imagen1, 'https://github.com/Dkdkdk293/VegettaBot', '𝙑𝙚𝙜𝙚𝙩𝙩𝙖𝘽𝙤𝙩', null, null, [
['𝙈𝙚𝙣𝙪́ 𝙘𝙤𝙢𝙥𝙡𝙚𝙩𝙤', '.allmenu'],
['𝙑𝙚𝙡𝙤𝙘𝙞𝙙𝙖𝙙', '/ping'],
...
conn.sendHydrated(m.chat, estado, `𝙑𝙀𝙂𝙀𝙏𝙏𝘼𝘽𝙊𝙏 - 𝘼𝙎𝙄𝙎𝙏𝙀𝙉𝘾𝙄𝘼\n${asistencia}\n\n` + wm, picture, 'https://github.com/Dkdkdk293/VegettaBot', '𝙑𝙚𝙜𝙚𝙩𝙩𝙖𝘽𝙤𝙩', null, null, [
['𝙈𝙚𝙣𝙪́ 𝙘𝙤𝙢𝙥𝙡𝙚𝙩𝙤', '.allmenu'],
['𝙑𝙚𝙡𝙤𝙘𝙞𝙙𝙖𝙙', '/ping'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́', '#menu']
], m,)}*/
